...
for strategy in [PreprocessingStrategy.RISK_ONLY, PreprocessingStrategy.KEYWORD]:
    ...
    output_dir = settings.results_dir / "samples" / strategy.value
...
print("\n✅ Sample files created in data/results/samples/")
print("\nView them with:")
print(f"  cat {settings.results_dir}/samples/risk_only/RELX_risk_only.md | head -100")
print(f"  cat {settings.results_dir}/samples/keyword/RELX_keyword.md | head -100")
