...
from .schemas import MentionTypeResponse
...
class MentionTypeClassifier(BaseClassifier):
    ...
    RESPONSE_MODEL = MentionTypeResponse
    ...
    def extract_result(
        ...
        """Extract classification result from MentionTypeResponse."""
        response: MentionTypeResponse = parsed  # type: ignore
