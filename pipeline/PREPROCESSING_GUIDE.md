...
**Output:**
- `/output/preprocessed/risk_only/04366849_risk_only.md`
- `/output/preprocessed/keyword/04366849_keyword.md`
...
4. Save markdown files to `/output/preprocessed/keyword/`
...
3. **Review markdown outputs** in `/output/preprocessed/keyword/`
...
- Review sample outputs in `output/preprocessed/`
