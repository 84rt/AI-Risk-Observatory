...
- Creates `data/results/risk_classifications/golden_set_results.json`
...
- [ ] Output directory exists (`data/results/risk_classifications/`)
...
2. **No preprocessed files**
   ...
   - Or check: `ls data/processed/preprocessed/keyword/`
