...
2. Place them in `data/raw/pdfs/` folder
...
2. Place in `data/raw/pdfs/` with naming: `{company_number}_{name}_{year}.pdf`
3. Test rest of pipeline (PDF extraction → LLM → Database)

Example:
```
data/raw/pdfs/01026167_Barclays_Bank_PLC_2024.pdf
data/raw/pdfs/00102498_BP_PLC_2024.pdf
```
