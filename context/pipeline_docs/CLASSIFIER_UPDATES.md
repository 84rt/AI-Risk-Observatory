...
rm data/results/risk_classifications/golden_set_results.json
...
cat data/results/risk_classifications/golden_set_results.json | jq '.[] | {firm: .firm_name, key_snippets: .key_snippets}'
```
