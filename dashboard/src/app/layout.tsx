          ...
          <div className="mx-auto max-w-7xl px-6 py-12 flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[10px] text-muted-foreground uppercase tracking-widest">
                &copy; {new Date().getFullYear()} Monitoring AI adoption and risk in UK Public Companies
              </p>
            </div>
            <a
              ...
              className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted transition-colors hover:text-accent"
            >
